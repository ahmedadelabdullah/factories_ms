				...
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							...
							{{-- <img alt="user-img" class="avatar avatar-xl brround" src="{{(!empty(Auth::user()->photo ? url('upload/images/' . Auth::user()->photo)) : url('uploads/profile_images/no_image.png')}}"><span class="avatar-status profile-status bg-green"></span> --}}

						</div>
						<div class="user-info">
							<h4 class="font-weight-semibold mt-3 mb-0">{{$user->name}}</h4>
							<span class="mb-0 text-muted">{{$user->user_name}}</span>
						</div>
					</div>
				</div>
				<ul class="side-menu">
