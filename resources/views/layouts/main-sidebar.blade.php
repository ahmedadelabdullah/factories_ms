				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							{{-- <li><a class="slide-item" href="{{route('customeraccounts.index')}}">حساب العملاء</a></li> --}}
							<li><a class="slide-item" href="{{route('customerinvoices.index')}}">فواتير العملاء</a></li>

							<li><a class="slide-item" href="{{route('sales_returns.index')}}">مرتجعات العملاء</a></li>
							<li><a class="slide-item" href="{{route('payments.index')}}">دفعات العملاء</a></li>
						</ul>
					</li>
